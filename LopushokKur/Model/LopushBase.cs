...
namespace LopushokKur.Model
{
    public partial class LopushBase : DbContext
    {
        private static LopushBase _context;
        public LopushBase()
            : base("name=LopushBase")
        {
        }

        public static LopushBase GetContext()
        {
            if (_context == null)
                _context = new LopushBase();
